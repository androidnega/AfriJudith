...
final class ProfileModel extends Model
{
    ...
    public function projects(): array
    {
        return [
            ...
            [
                'title'    => 'Personal Finance Notebook',
                'category' => 'Data Analytics',
                'icon'     => 'fa-solid fa-wallet',
                'summary'  => 'A Python notebook that categorizes mobile money transactions and surfaces spending patterns.',
            ...
            [
                ...
                'summary'  => 'A clean REST API for searching, borrowing, and returning library books, with role-based access.',
                'stack'    => ['PHP', 'MySQL', 'REST'],
                'url'      => '#',
            ],
            [
                'title'    => 'Election Polls Visualizer',
                'category' => 'Data Analytics',
                'icon'     => 'fa-solid fa-chart-pie',
                'summary'  => 'A simple, fast viewer for SRC election results — live percentages, swing, and turnout charts.',
                'stack'    => ['JavaScript', 'D3.js', 'CSV'],
                'url'      => '#',
            ],
            [
                ...
                'summary'  => 'A small-business stock manager with low-stock alerts and weekly sell-through reports.',
